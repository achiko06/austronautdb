...
const Navbar = () => {
    ...
    return (
      ...
      {user ? ( 
          <div 
          className={`${showUserDropdown ? '' : 'hidden'} z-50 mt-20 w-full sm:w-1/2 md:w-1/3 xl:w-1/6 fixed right-0 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600`}
          >
              <div className="px-4 py-3">
                          <span className="block text-sm text-gray-900 dark:text-white">name</span>
                          <span className="block text-sm font-medium text-gray-500 truncate dark:text-gray-400">id</span>
              </div>
